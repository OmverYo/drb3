...
class HangulEngine:
    ...
    JAMO_STROKES = {
        'ㄱ': [[(0.1, 0.1), (0.9, 0.1), (0.9, 0.9)]], 'ㄴ': [[(0.1, 0.1), (0.1, 0.9), (0.9, 0.9)]], 'ㄷ': [[(0.1, 0.1), (0.9, 0.1)], [(0.1, 0.1), (0.1, 0.9), (0.9, 0.9)]], 'ㄹ': [[(0.1, 0.1), (0.9, 0.1), (0.9, 0.5), (0.1, 0.5), (0.1, 0.9), (0.9, 0.9)]], 'ㅁ': [[(0.1, 0.1), (0.1, 0.9)], [(0.1, 0.1), (0.9, 0.1), (0.9, 0.9), (0.1, 0.9)]], 'ㅂ': [[(0.2, 0.1), (0.2, 0.9)], [(0.8, 0.1), (0.8, 0.9)], [(0.2, 0.5), (0.8, 0.5)], [(0.2, 0.9), (0.8, 0.9)]], 'ㅅ': [[(0.5, 0.1), (0.1, 0.9)], [(0.5, 0.5), (0.9, 0.9)]], 'ㅇ': [[(0.5, 0.1), (0.2, 0.3), (0.2, 0.7), (0.5, 0.9), (0.8, 0.7), (0.8, 0.3), (0.5, 0.1)]], 'ㅈ': [[(0.1, 0.1), (0.9, 0.1)], [(0.5, 0.1), (0.1, 0.9)], [(0.5, 0.5), (0.9, 0.9)]], 'ㅊ': [[(0.4, 0.0), (0.6, 0.0)], [(0.1, 0.2), (0.9, 0.2)], [(0.5, 0.2), (0.1, 0.9)], [(0.5, 0.5), (0.9, 0.9)]], 'ㅋ': [[(0.1, 0.1), (0.9, 0.1), (0.9, 0.9)], [(0.1, 0.5), (0.9, 0.5)]], 'ㅌ': [[(0.1, 0.1), (0.9, 0.1)], [(0.1, 0.5), (0.9, 0.5)], [(0.1, 0.1), (0.1, 0.9), (0.9, 0.9)]], 'ㅍ': [[(0.1, 0.1), (0.9, 0.1)], [(0.3, 0.1), (0.3, 0.9)], [(0.7, 0.1), (0.7, 0.9)], [(0.1, 0.9), (0.9, 0.9)]], 'ㅎ': [[(0.4, 0.0), (0.6, 0.0)], [(0.2, 0.2), (0.8, 0.2)], [(0.5, 0.3), (0.3, 0.5), (0.5, 0.7), (0.7, 0.5), (0.5, 0.3)]],
        'ㅏ': [[(0.3, 0.1), (0.3, 0.9)], [(0.3, 0.5), (0.8, 0.5)]], 'ㅑ': [[(0.3, 0.1), (0.3, 0.9)], [(0.3, 0.4), (0.8, 0.4)], [(0.3, 0.6), (0.8, 0.6)]], 'ㅓ': [[(0.8, 0.1), (0.8, 0.9)], [(0.3, 0.5), (0.8, 0.5)]], 'ㅕ': [[(0.8, 0.1), (0.8, 0.9)], [(0.3, 0.4), (0.8, 0.4)], [(0.3, 0.6), (0.8, 0.6)]], 'ㅗ': [[(0.1, 0.7), (0.9, 0.7)], [(0.5, 0.2), (0.5, 0.7)]], 'ㅛ': [[(0.1, 0.7), (0.9, 0.7)], [(0.3, 0.2), (0.3, 0.7)], [(0.7, 0.2), (0.7, 0.7)]], 'ㅜ': [[(0.1, 0.3), (0.9, 0.3)], [(0.5, 0.3), (0.5, 0.8)]], 'ㅠ': [[(0.1, 0.3), (0.9, 0.3)], [(0.3, 0.3), (0.3, 0.8)], [(0.7, 0.3), (0.7, 0.8)]], 'ㅡ': [[(0.1, 0.5), (0.9, 0.5)]], 'ㅣ': [[(0.5, 0.1), (0.5, 0.9)]],
    }

    @staticmethod
    def scale_strokes(char_jamo, bx, by, bw, bh):
        if char_jamo not in HangulEngine.JAMO_STROKES: return []
        return [[(bx + (x * bw), by + (y * bh)) for x, y in stroke] for stroke in HangulEngine.JAMO_STROKES[char_jamo]]

    @classmethod
    def get_char_strokes(cls, char, box_width=40.0, box_height=40.0):
        if char == " ": return []
        code = ord(char)
        if code < 0xAC00 or code > 0xD7A3: return []
        offset = code - 0xAC00
        jong_idx = offset % 28
...
class BrailleTask:
    ...
    def execute(self, flat_bits, logger):
        ...
        try:
            ...
            # 핀 들기
            movel(posx([0.0, 0.0, -35.0, 0.0, 0.0, 0.0]), vel=self.Z_VEL, acc=self.Z_ACC, ref=DR_TOOL, mod=DR_MV_MOD_REL)
            logger.info("점자 타각 시작!")

            def punch_dot():
                safe_pos = get_current_posx(ref=DR_BASE)[0]
                try:
                    movel(posx([0.0, 0.0, 34.0, 0.0, 0.0, 0.0]), vel=self.Z_VEL, acc=self.Z_ACC, ref=DR_TOOL, mod=DR_MV_MOD_REL)
                    ...
                    check_force_condition(DR_AXIS_Z, min=2.75, max=30.0, ref=DR_TOOL)
                finally:
            ...
            for i in range(num_chars):
                ...
                if i != num_chars - 1:
                    movel(posx([self.CHAR_OFFSET - char_cur_x, -char_cur_y, 0.0, 0.0, 0.0, 0.0]), vel=self.MOVE_VEL, acc=self.MOVE_ACC, ref=DR_TOOL, mod=DR_MV_MOD_REL)
